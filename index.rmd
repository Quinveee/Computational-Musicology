...
### Analysis over the entire range of songs {style="min-height:1200px"}
...
### Plot B {style="min-height:600px"}

```{r, echo=FALSE, style="margin-left:-400px"}
